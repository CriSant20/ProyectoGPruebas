...
router.get('/:id', pexternos_controller_1.getPExternoById);
router.put('/:id', pexternos_controller_1.updatePExterno);
router.delete('/:id', pexternos_controller_1.deletePExterno);
