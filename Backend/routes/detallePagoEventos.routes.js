...
router.get('/:id', dPeventos_controller_1.getPEventoById);
router.put('/:id', dPeventos_controller_1.updatePEventos);
router.delete('/:id', dPeventos_controller_1.deletePEventos);
